          ...
          <div className="lg:col-span-9">
            ...
            <div className="space-y-6 text-white/60 text-base leading-[1.9] reveal reveal-delay-1">
              <p className="text-white/80">
                Zachary Leifer is a Las Vegas-based commercial growth and transformation executive who connects AI, digital, data, and technology to measurable business outcomes. As founder of State of Mind Strategies, he advises executives and organizations on AI adoption, digital transformation, commercial strategy, customer data, and operating-model improvement.
              </p>
              <p>
                He has served as Chief Marketing Officer at 1/ST Technology, Chief Commercial Officer at PokerAtlas, and Vice President of Corporate Information Technology at Las Vegas Sands. He leads marketing, commercial, digital, data, and technology initiatives that connect customer insight and operating capabilities to measurable business outcomes. His career spans integrated resorts and gaming, hospitality, sports wagering and horse racing, gaming technology, eCommerce and sports media, across B2B, B2C, direct-to-consumer, subscription, and platform businesses, beginning at MLB Advanced Media.
              </p>
              <p>
