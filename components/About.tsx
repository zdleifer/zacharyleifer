        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-9">
            ...
            <div className="space-y-6 text-white/60 text-base leading-[1.9] reveal reveal-delay-1">
              ...
              <p>
                He has served as Chief Marketing Officer at 1/ST Technology, Chief Commercial Officer at PokerAtlas, and Vice President of Corporate Information Technology at Las Vegas Sands. His career spans integrated resorts and gaming, hospitality, sports wagering and horse racing, gaming technology, eCommerce and sports media, across B2B, B2C, direct-to-consumer, subscription, and platform businesses, beginning at MLB Advanced Media.
              </p>
              <p>
